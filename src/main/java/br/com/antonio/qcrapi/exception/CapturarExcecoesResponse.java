...
public class CapturarExcecoesResponse extends ResponseEntityExceptionHandler{
    ...
    public ResponseEntity<Object> handleEmptyResultDataAccessException(SQLSyntaxErrorException ex, WebRequest request ) {
